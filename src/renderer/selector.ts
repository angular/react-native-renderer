...
// Code taken from https://github.com/angular/angular/blob/master/modules/%40angular/compiler/src/compiler.ts
  ...
  static parse(selector: string): CssSelector[] {
    ...
    var _addResult = (res: CssSelector[], cssSel: CssSelector) => {
      if (cssSel.notSelectors.length > 0 && isBlank(cssSel.element) &&
        cssSel.classNames.length == 0 && cssSel.attrs.length == 0) {
        cssSel.element = '*';
      }
      res.push(cssSel);
    };
